...
public class SpringContactApp implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		// MyUser sam = new MyUser("Carter", "Samantha",
		// "major.samantha.carter@sgc.com", "USER");
		...
		// contactRepository.save(new Contact("Carter", "major.samantha.carter@sgc.com",
		// jack, sg1));
		// contactRepository.save(new Contact("O'Neill", "jack.oneill@sgc.us", sam,
		// sg1));
		// contactRepository.save(new Contact("Jackson", "daniel.jackson@sgc.us", sam,
		// sg1));
		// contactRepository.save(new Contact("Frasier", "janet.frasier@sgc.us", sam,
		// medic));
		// contactRepository.save(new Contact("Hammond", "georges.hammond@sgc.us", sam,
		// admin));
	}
}
